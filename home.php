                ...
                <ul class="dropdown-menu">
                 ...
                 if($numrow>0){
                  while($row_type=mysqli_fetch_assoc($result_type)){
                    ...
                    $id_type=$row_type['id'];
                    echo' <li><a class="menu dropdown-item" href="home.php?type_name='.$type_food.'#menu">'.$type_food.'</a></li>
                    ';
                  }
                  ...
                  if($numrow2>0){
                    while($row_country=mysqli_fetch_assoc($result_country)){
                      ...
                      $name_country=$row_country['Country_name'];
                        ...
                        echo' <li><a class="menu dropdown-item" href="home.php?country_name='.$name_country.'#menu">'.$name_country.'</a></li>';
                    }
...
<div class="view ">
  ...
  <div class="view-cont  row">
    ...
    <div class="view-info col">
      ...
      <p><?php echo show_number_food();?></p>
      <p>Foods</p>
    </div>

    <div class="view-info col">
      <i class="fa-solid fa-flag"></i>
      <p><?php echo show_number_country();?></p>
      <p> Global Food</p>
    </div>
    ...
    <div class="view-info col">
      ...
      <p><?php echo show_number_feedback();?></p>
      <p>Feedback</p>
    </div>
...
?>
      ...
      <form method="post">
        ...
        <input  class="msg" type="text" name="name" placeholder="Enter Your Name" required="required" >
        <input class="msg" type="email" name="email" placeholder="Enter Your Email" required="required">
        <input class="msg-edit" type="text" name="massage" placeholder="Enter Your Massage" required="required">
        <input type="Submit" name="Send_feed" class="send-msg" value='Send' >
